...
public class QueryUtilsForArtistScreen {

    private QueryUtilsForArtistScreen() {
    }
    ...
    private static List<MusicObject> extractFeatureFromJson(String musicObjectJSON, int num) /*throws JSONException*/ {
...
//                if(h == num /*given value*/ ){
                ...
                JSONObject rootObject = root.getJSONObject(num);
...
//                                    songUrl,
    ...
    public static List<MusicObject> fetchMusicObjectData(String requestUrl, int num) {
        ...
        List<MusicObject> musicObjects = extractFeatureFromJson(jsonResponse, num);
        return musicObjects;
    }
